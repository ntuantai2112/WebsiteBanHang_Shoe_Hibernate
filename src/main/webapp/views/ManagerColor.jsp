        ...
        <div class="card-body">
            <form action="/color/add" method="post">
                <div class="form-group">
                    ...
                    <input type="text" class="form-control" required name="ma" placeholder="Mã màu sắc">
                </div>

                <div class="form-group">
                    <%--@declare id=""--%><label for="">Tên màu sắc</label>
                    <input type="text" required class="form-control" name="ten" placeholder="Tên màu sắc">
                </div>
