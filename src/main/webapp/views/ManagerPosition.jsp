        ...
        <div class="card-body">
            <form action="/position/add" method="post">
                <div class="form-group">
                    ...
                    <input type="text" required class="form-control" name="ma" placeholder="Mã chức vụ">
                </div>

                <div class="form-group">
                    <%--@declare id=""--%><label for="">Tên chức vụ</label>
                    <input type="text" required class="form-control" name="ten" placeholder="Tên chức vụ">
                </div>
